...
_AVAILABLE_MAPPING = {
    ...
    MODEL_HUIZUO_FANWY: _MAPPING.update(_MAPPING_FAN_WY),
    MODEL_HUIZUO_FANWY2: _MAPPING.update(_MAPPING_FAN_WY2),
    MODEL_HUIZUO_WY200: _MAPPING.update(_MAPPING_SCENE),
    MODEL_HUIZUO_WY201: _MAPPING.update(_MAPPING_SCENE),
    MODEL_HUIZUO_WY202: _MAPPING.update(_MAPPING_SCENE),
    MODEL_HUIZUO_WY203: _MAPPING.update(_MAPPING_SCENE),
    MODEL_HUIZUO_WYHEAT: _MAPPING.update(_MAPPING_SCENE)
}
