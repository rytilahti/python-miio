...
_AVAILABLE_MAPPING = {
    ...
    MODEL_HUIZUO_FANWY: dict(_MAPPING.items() + _MAPPING_FAN_WY.items()),
    MODEL_HUIZUO_FANWY2: dict(_MAPPING.items() + _MAPPING_FAN_WY2.items()),
    MODEL_HUIZUO_WY200: dict(_MAPPING.items() + _MAPPING_SCENE.items()),
    MODEL_HUIZUO_WY201: dict(_MAPPING.items() + _MAPPING_SCENE.items()),
    MODEL_HUIZUO_WY202: dict(_MAPPING.items() + _MAPPING_SCENE.items()),
    MODEL_HUIZUO_WY203: dict(_MAPPING.items() + _MAPPING_SCENE.items()),
    MODEL_HUIZUO_WYHEAT: dict(_MAPPING.items() + _MAPPING_SCENE.items())
}
