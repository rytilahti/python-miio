...
from miio.utils import pretty_rgb
...
class TestPhilipsMoonlight(TestCase):
    ...
    def test_status(self):
        ...
        assert self.state().rgb == pretty_rgb(int(self.device.start_state["rgb"]))
    ...
    def test_set_rgb(self):
        ...
        assert rgb() == pretty_rgb(1)
        self.device.set_rgb(16711680)
        assert rgb() == pretty_rgb(16711680)
        self.device.set_rgb(16777215)
        assert rgb() == pretty_rgb(16777215)
