...
from .ptxswitch import (MODEL_PTX_ONE_INTELLIGENT_SWITCH, MODEL_PTX_TWO_INTELLIGENT_SWITCH,
                        MODEL_PTX_THREE_INTELLIGENT_SWITCH)
...
DEVICE_MAP = {
    "090615.switch.switch01" : partial(PtxSwitch, model=MODEL_PTX_ONE_INTELLIGENT_SWITCH),
    "090615.switch.switch02" : partial(PtxSwitch, model=MODEL_PTX_TWO_INTELLIGENT_SWITCH),
    "090615.switch.switch03" : partial(PtxSwitch, model=MODEL_PTX_THREE_INTELLIGENT_SWITCH),
