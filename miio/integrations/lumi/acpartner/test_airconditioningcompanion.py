...
from .airconditioningcompanionMCN import FanSpeed as FanSpeedMcn02
from .airconditioningcompanionMCN import OperationMode as OperationModeMcn02
from .airconditioningcompanionMCN import SwingMode as SwingModeMcn02
