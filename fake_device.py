...
while True:
    ...
    token = bytes.fromhex('9bc7c7ce6291d3e443fd7708608b9892')
    device_id = 120009025
    if data == helobytes:
        ...
        result = methods_responses[request.data.value['method']](request.data.value['id'], request.data.value['params'])
        msg = {"data": {"value": result}, "header": {"value": header}, "checksum": 0}
