...
This release comes with a crisp, unified and scalable command line interface called `miiocli` (thanks @yawor). It can be used to control each supported device.
